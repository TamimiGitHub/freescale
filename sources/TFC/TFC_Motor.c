...
void TFC_SetPWMLookup(int setA, int setB)
{
	setA += 50;
	setB += 50;
	TPM0_C2V = (uint16_t) ((float)TPM0_MOD *PWMtable[setA]);
	TPM0_C3V = TPM0_C2V;
	TPM0_C0V = (uint16_t) ((float)TPM0_MOD *PWMtable[setB]);
	TPM0_C1V = TPM0_C0V;
}
...
void TFC_SetMotorPWM(float MotorA , float MotorB)
{
	...
	TPM0_C2V = (uint16_t) ((float)TPM0_MOD * ((MotorA + 1.0)/2.0));
	TPM0_C3V = TPM0_C2V;
	TPM0_C0V = (uint16_t) ((float)TPM0_MOD * ((MotorB + 1.0)/2.0));
	TPM0_C1V = TPM0_C0V;
